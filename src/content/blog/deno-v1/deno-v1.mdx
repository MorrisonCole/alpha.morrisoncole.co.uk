...
import denoArt from "./deno_art.jpg?w=480;800;1200&format=webp;jpg&as=picture";
...
<ResponsiveImage picture={denoArt} alt="Deno Launch Art" />

Aside from the fact I can't disassociate the name of this tool from that of an
extraordinarily talented ex-colleague, Deno is all new to me.
...
> 💡 You can read more about Deno in the author's own words at:
...
First I spent a while trying to write something vaguely functional-looking, but
gave up.
