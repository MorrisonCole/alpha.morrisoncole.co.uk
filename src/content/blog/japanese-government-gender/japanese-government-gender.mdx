...
import populationBreakdown from "./population-vs-gov-breakdown.png?w=480;800;1200&format=webp;png&as=picture";
import lowerHouse from "./lower-house.png?w=480;800;1200&format=webp;png&as=picture";
